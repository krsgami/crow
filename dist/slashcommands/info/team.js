...
import { getTeamWithMatches, searchTeams, } from "../../services/football_data.service.js";
...
export default class TimeSlashCommand extends SlashCommand {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const embed = await TeamInfoEmbed(result.team, result.lastMatch, result.nextMatch, interaction, interaction.client);
