...
import { searchEsportsTeams, getEsportsTeamById, getTeamMatches, } from "../../services/esports_data.service.js";
...
export default class EsportsTeamSlashCommand extends SlashCommand {
    ...
    async autocomplete(interaction) {
        ...
        try {
            ...
            await interaction.respond(teams.slice(0, 25).map((team) => ({
                name: `${team.name}${team.acronym ? ` (${team.acronym})` : ""}`.slice(0, 100),
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const embed = await TeamInfoEmbed(team, jogo, matches, interaction, interaction.client);
...
//# sourceMappingURL=esportsTeam.js.map