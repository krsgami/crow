    ...
    async execute(message) {
        ...
        try {
            ...
            if (result.leveledUp && channel.isSendable()) {
                const embed = await levelUpEmbed(author, oldLevel, result.current.level, result.current.level - oldLevel, result.current.exp, result.current.level_up_exp, exp, guild);
...
//# sourceMappingURL=giveExp.js.map