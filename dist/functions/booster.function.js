...
function getFullTime(startDate, endDate = new Date()) {
...
export function getBoostBadge(member) {
    ...
    const tier = BOOST_TIERS.find((tier) => months >= tier.months) ??
...
//# sourceMappingURL=booster.function.js.map