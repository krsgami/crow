...
export async function TeamInfoEmbed(team, jogo, matches, interaction, client) {
    ...
    const embed = new EmbedBuilder()
        ...
        .addFields({ name: "ID", value: String(team.id), inline: true }, { name: "Slug", value: team.slug || "N/A", inline: true }, { name: "Tag", value: team.acronym || "N/A", inline: true }, { name: "País", value: team.location || "N/A", inline: true }, {
        name: "Último jogo",
