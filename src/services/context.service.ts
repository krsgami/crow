...
} from "../repositories/userStats.repository.js";
import {
  createGuild,
  getGuildByDiscordId,
  upsertGuild,
} from "../repositories/guilds.repository.js";
import {
  createGuildSettings,
  getGuildSettings,
} from "../repositories/guildSettings.repository.js";
import {
  createGuildMember,
  getGuildMember,
...
export async function getOrCreateGuildSettings(guildId: number) {
...
export async function getOrCreateGuildMember(guildId: number, userId: number) {
